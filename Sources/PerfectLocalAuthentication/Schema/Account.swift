...
//public class UserAccount<UserExtension : PostgresStORM> : PostgresStORM {
//
//    public var id              = ""
//    public var username          = ""
//    public var password          = ""
...
//    }
//
//    public func rows() -> [UserAccount] {
//        var rows = [UserAccount]()
//        for i in 0..<self.results.rows.count {
//            let row = UserAccount<UserExtension>()
//            row.to(self.results.rows[i])
//            rows.append(row)
//        }
//        return rows
...
//
//    // Register User
//    public static func login(_ u: String, _ p: String) throws -> UserAccount {
//        if let digestBytes = p.digest(.sha256),
//            let hexBytes = digestBytes.encode(.hex),
//            let hexBytesStr = String(validatingUTF8: hexBytes) {
//
